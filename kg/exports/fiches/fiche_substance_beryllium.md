# Fiche pédagogique — **Béryllium et composés**
...
- **Nom français** : Béryllium et composés
- **Nom anglais** : Beryllium
- **N° CAS** : `7440-41-7`
- **Catégorie** : metal
...
|---|---|---|---|
| **Berylliose** | autre | moderee | IARC-1 |
| **Cancer pulmonaire beryllium** | cancer | grave | IARC-1 |

## 3. Tableaux de maladies professionnelles applicables

| Tableau | Intitulé | Régime | Variante |
|---|---|---|---|
| **`RG-33`** | Maladies professionnelles dues au béryllium et à ses composés | RG | — |
...
**INDUSTRIE** : Aeronautique, Alliages speciaux, Electronique, Nucleaire
...
|---|---|---|---|---|
| Berylliose | **Scanner thoracique** | 24 mois | `INRS-2018` | 2018 |
...
```mermaid
graph LR
    S["Béryllium et composés"]
    berylliose["Berylliose"]
    S -->|CAUSE| berylliose
    cancer_pulmonaire_beryllium["Cancer pulmonaire beryllium"]
    S -->|CAUSE| cancer_pulmonaire_beryllium
    RG_33["RG-33"]
    berylliose -.->|classifiée dans| RG_33
...
> Pour la vue complète : `kg/exports/debby_kg_beryllium_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/beryllium
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance beryllium`
