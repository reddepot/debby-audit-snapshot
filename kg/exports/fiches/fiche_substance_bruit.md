# Fiche pédagogique — **Bruit (≥80 dB(A) sur 8h)**
...
- **Nom français** : Bruit (≥80 dB(A) sur 8h)
- **Nom anglais** : Occupational noise
- **Catégorie** : physique
...
|---|---|---|---|
| **Acouphenes** | autre | moderee | — |
| **Fatigue auditive** | autre | moderee | — |
| **Hyperacousie** | autre | moderee | — |
| **Surdite professionnelle** | autre | moderee | — |

## 3. Tableaux de maladies professionnelles applicables

| Tableau | Intitulé | Régime | Variante |
|---|---|---|---|
| **`RG-42`** | Atteinte auditive provoquée par les bruits lésionnels | RG | — |
...
**INDUSTRIE** : Industrie metallurgie, Musicien pro

**SERVICES** : Aeroport, Tonnerre textile
...
|---|---|---|---|---|
| Surdite professionnelle | **Audiogramme** | 36 mois | `INRS-2021` | 2021 |
...
```mermaid
graph LR
    S["Bruit (≥80 dB(A) sur 8h)"]
    acouphenes["Acouphenes"]
    S -->|CAUSE| acouphenes
    fatigue_auditive["Fatigue auditive"]
    S -->|CAUSE| fatigue_auditive
    hyperacousie["Hyperacousie"]
    S -->|CAUSE| hyperacousie
    surdite_professionnelle["Surdite professionnelle"]
    S -->|CAUSE| surdite_professionnelle
    RG_42["RG-42"]
    acouphenes -.->|classifiée dans| RG_42
...
> Pour la vue complète : `kg/exports/debby_kg_bruit_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/bruit
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance bruit`
