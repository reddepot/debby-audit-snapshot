# Fiche pédagogique — **Farines (céréales, blé, seigle)**
...
- **Nom français** : Farines (céréales, blé, seigle)
- **Nom anglais** : Cereal flours
...
|---|---|---|---|
| **Alvéolite allergique** | autre | moderee | — |
| **Asthme boulanger** | respiratoire | moderee | — |
| **Rhinite boulanger** | autre | moderee | — |

## 3. Tableaux de maladies professionnelles applicables

| Tableau | Intitulé | Régime | Variante |
|---|---|---|---|
| **`RA-45`** | Asthmes professionnels agricoles (farines, céréales, animaux) | RA | — |
| **`RG-66`** | Rhinites et asthmes professionnels | RG | — |
...
**INDUSTRIE** : Boulanger, Meunier, Ouvrier alimentation, Patissier
...
|---|---|---|---|---|
| Asthme boulanger | **Épreuves fonctionnelles respiratoires (EFR)** | 12 mois | `INRS-2017` | 2017 |
...
```mermaid
graph LR
    S["Farines (céréales, blé, seigle)"]
    alvéolite_allergique["Alvéolite allergique"]
    S -->|CAUSE| alvéolite_allergique
    asthme_boulanger["Asthme boulanger"]
    S -->|CAUSE| asthme_boulanger
    rhinite_boulanger["Rhinite boulanger"]
    S -->|CAUSE| rhinite_boulanger
    RA_45["RA-45"]
    alvéolite_allergique -.->|classifiée dans| RA_45
    RG_66["RG-66"]
    alvéolite_allergique -.->|classifiée dans| RG_66
...
> Pour la vue complète : `kg/exports/debby_kg_farines_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/poussieres-farines
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance farines`
