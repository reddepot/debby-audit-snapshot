# Fiche pédagogique — **Isocyanates organiques (TDI, MDI, HDI)**
...
- **Nom français** : Isocyanates organiques (TDI, MDI, HDI)
- **Nom anglais** : Organic isocyanates
- **N° CAS** : `584-84-9`
- **Catégorie** : cov
...
|---|---|---|---|
| **Asthme isocyanates** | respiratoire | moderee | IARC-2B |
| **Pneumopathie hypersensibilite** | respiratoire | moderee | IARC-2B |

## 3. Tableaux de maladies professionnelles applicables

| Tableau | Intitulé | Régime | Variante |
|---|---|---|---|
| **`RA-43`** | Tableau RA n°43 | RA | — |
| **`RG-62`** | Affections professionnelles provoquées par les isocyanates organiques | RG | — |
...
**INDUSTRIE** : Applicateur resines, Ouvrier mousses polyurethane, Peintre carrosserie
...
|---|---|---|---|---|
| Asthme isocyanates | **Épreuves fonctionnelles respiratoires (EFR)** | 12 mois | `INRS-2017` | 2017 |
...
```mermaid
graph LR
    S["Isocyanates organiques (TDI, MDI, HDI)"]
    asthme_isocyanates["Asthme isocyanates"]
    S -->|CAUSE| asthme_isocyanates
    pneumopathie_hypersensibilite["Pneumopathie hypersensibilite"]
    S -->|CAUSE| pneumopathie_hypersensibilite
    RA_43["RA-43"]
    asthme_isocyanates -.->|classifiée dans| RA_43
    RG_62["RG-62"]
    asthme_isocyanates -.->|classifiée dans| RG_62
...
> Pour la vue complète : `kg/exports/debby_kg_isocyanates_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/isocyanates
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance isocyanates`
