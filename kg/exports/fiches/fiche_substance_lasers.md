# Fiche pédagogique — **Rayonnements laser**
...
- **Nom français** : Rayonnements laser
- **Nom anglais** : Laser radiation
- **Catégorie** : physique
...
|---|---|---|---|
| **Brulure retinienne laser** | autre | moderee | — |
| **Lesion cutanee laser** | autre | moderee | — |
...
**INDUSTRIE** : Esthetique epilation, Industrie decoupe, Metrologie
...
```mermaid
graph LR
    S["Rayonnements laser"]
    brulure_retinienne_laser["Brulure retinienne laser"]
    S -->|CAUSE| brulure_retinienne_laser
    lesion_cutanee_laser["Lesion cutanee laser"]
    S -->|CAUSE| lesion_cutanee_laser
...
> Pour la vue complète : `kg/exports/debby_kg_lasers_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/lasers
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance lasers`
