# Fiche pédagogique — **Manutention manuelle de charges lourdes**
...
- **Nom français** : Manutention manuelle de charges lourdes
- **Nom anglais** : Manual handling
...
|---|---|---|---|
| **Cruralgie** | autre | moderee | — |
| **Hernie discale** | autre | moderee | — |
| **Lombalgie chronique** | autre | moderee | — |
| **Sciatique** | autre | moderee | — |
...
**INDUSTRIE** : Ouvrier agroalimentaire

**SANTE** : Soignant

**TRANSPORT_LOGISTIQUE** : Demenageur, Logistique
...
|---|---|---|---|---|
| Lombalgie chronique | **Examen neurologique clinique** | 12 mois | `INRS-TMS-2020` | 2020 |
...
```mermaid
graph LR
    S["Manutention manuelle de charges lourdes"]
    cruralgie["Cruralgie"]
    S -->|CAUSE| cruralgie
    hernie_discale["Hernie discale"]
    S -->|CAUSE| hernie_discale
    lombalgie_chronique["Lombalgie chronique"]
    S -->|CAUSE| lombalgie_chronique
    sciatique["Sciatique"]
    S -->|CAUSE| sciatique
    RG_79["RG-79"]
    cruralgie -.->|classifiée dans| RG_79
    RG_98["RG-98"]
    cruralgie -.->|classifiée dans| RG_98
...
> Pour la vue complète : `kg/exports/debby_kg_manutention_manuelle_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/manutention-manuelle
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance manutention_manuelle`
