# Fiche pédagogique — **Persulfates alcalins (coiffure)**
...
- **Nom français** : Persulfates alcalins (coiffure)
- **Nom anglais** : Alkaline persulfates
- **N° CAS** : `7727-21-1`
- **Catégorie** : chimique
...
|---|---|---|---|
| **Asthme persulfates** | respiratoire | moderee | — |
| **Rhinite persulfates** | autre | moderee | — |
| **Dermatite coiffeur** | cutanee | legere | — |
...
**INDUSTRIE** : Coiffeur, Decolorateur
...
|---|---|---|---|---|
| Asthme persulfates | **Épreuves fonctionnelles respiratoires (EFR)** | 12 mois | `INRS-2017` | 2017 |
...
```mermaid
graph LR
    S["Persulfates alcalins (coiffure)"]
    asthme_persulfates["Asthme persulfates"]
    S -->|CAUSE| asthme_persulfates
    rhinite_persulfates["Rhinite persulfates"]
    S -->|CAUSE| rhinite_persulfates
    dermatite_coiffeur["Dermatite coiffeur"]
    S -->|CAUSE| dermatite_coiffeur
    RG_66["RG-66"]
    asthme_persulfates -.->|classifiée dans| RG_66
...
> Pour la vue complète : `kg/exports/debby_kg_persulfates_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/persulfates
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance persulfates`
