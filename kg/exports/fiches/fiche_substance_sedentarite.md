# Fiche pédagogique — **Sédentarité prolongée**
...
- **Nom français** : Sédentarité prolongée
- **Nom anglais** : Occupational sedentary behavior
...
|---|---|---|---|
| **Diabete type 2** | autre | moderee | — |
| **Maladies cardiovasculaires sedentarite** | autre | moderee | — |
| **Obesite** | autre | moderee | — |
| **Syndrome metabolique sedentarite** | autre | moderee | — |
| **Tms position assise** | autre | moderee | — |
...
**TERTIAIRE** : Bureau tertiaire, Centre appels, Developpeur

**TRANSPORT_LOGISTIQUE** : Chauffeur taxi routier
...
|---|---|---|---|---|
| Syndrome metabolique sedentarite | **Bilan métabolique (glycémie, lipides, IMC, TA)** | 12 mois | `HAS-2022` | 2022 |
...
```mermaid
graph LR
    S["Sédentarité prolongée"]
    diabete_type_2["Diabete type 2"]
    S -->|CAUSE| diabete_type_2
    maladies_cardiovasculaires_sedentarite["Maladies cardiovasculaires sedentarite"]
    S -->|CAUSE| maladies_cardiovasculaires_sedentarite
    obesite["Obesite"]
    S -->|CAUSE| obesite
    syndrome_metabolique_sedentarite["Syndrome metabolique sedentarite"]
    S -->|CAUSE| syndrome_metabolique_sedentarite
    tms_position_assise["Tms position assise"]
    S -->|CAUSE| tms_position_assise
...
> Pour la vue complète : `kg/exports/debby_kg_sedentarite_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/sedentarite
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance sedentarite`
