# Fiche pédagogique — **Stress professionnel chronique**
...
- **Nom français** : Stress professionnel chronique
- **Nom anglais** : Chronic occupational stress
- **Catégorie** : rps
...
|---|---|---|---|
| **Anxiete professionnelle** | autre | moderee | — |
| **Burn out** | autre | moderee | — |
| **Depression reactionnelle** | autre | moderee | — |
| **Hta stress** | autre | moderee | — |
| **Syndrome metabolique stress** | autre | moderee | — |
| **Troubles sommeil** | autre | moderee | — |
...
**SANTE** : Aidant familial, Soignant

**SERVICES** : Forces ordre

**TERTIAIRE** : Cadre, Commercial, Enseignant
...
|---|---|---|---|---|
| Burn out | **Évaluation RPS (questionnaires WOCCQ, Karasek)** | 12 mois | `INRS-RPS-2023` | 2023 |
...
```mermaid
graph LR
    S["Stress professionnel chronique"]
    anxiete_professionnelle["Anxiete professionnelle"]
    S -->|CAUSE| anxiete_professionnelle
    burn_out["Burn out"]
    S -->|CAUSE| burn_out
    depression_reactionnelle["Depression reactionnelle"]
    S -->|CAUSE| depression_reactionnelle
    hta_stress["Hta stress"]
    S -->|CAUSE| hta_stress
    syndrome_metabolique_stress["Syndrome metabolique stress"]
    S -->|CAUSE| syndrome_metabolique_stress
...
> Pour la vue complète : `kg/exports/debby_kg_stress_chronique_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/stress
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance stress_chronique`
