...
| **Encephalopathie toluene** | neurologique | moderee | IARC-3 |
| **Neuropathie toluene** | neurologique | moderee | IARC-3 |
...
**INDUSTRIE** : Colle, Cordonnier, Imprimeur, Peintre
...
| Encephalopathie toluene | **Examen neurologique clinique** | 12 mois | `HAS-2021` | 2021 |
...
graph LR
    ...
    encephalopathie_toluene["Encephalopathie toluene"]
    S -->|CAUSE| encephalopathie_toluene
    neuropathie_toluene["Neuropathie toluene"]
    S -->|CAUSE| neuropathie_toluene
    RG_4_BIS["RG-4-BIS"]
...
> Pour la vue complète : `kg/exports/debby_kg_toluene_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/toluene
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance toluene`
