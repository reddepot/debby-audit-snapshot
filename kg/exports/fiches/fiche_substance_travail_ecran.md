# Fiche pédagogique — **Travail prolongé sur écran**
...
- **Nom français** : Travail prolongé sur écran
- **Nom anglais** : Computer work
...
|---|---|---|---|
| **Cervicalgie** | autre | moderee | — |
| **Fatigue visuelle** | autre | moderee | — |
| **Lombalgie assise** | autre | moderee | — |
| **Secheresse oculaire** | autre | moderee | — |
| **Syndrome canal carpien ecran** | autre | moderee | — |
...
**TERTIAIRE** : Bureau tertiaire, Centre appels, Developpeur, Graphiste, Secretaire
...
|---|---|---|---|---|
| Fatigue visuelle | **Bilan visuel / acuité / FO** | 24 mois | `INRS-écran` | 2019 |
...
```mermaid
graph LR
    S["Travail prolongé sur écran"]
    cervicalgie["Cervicalgie"]
    S -->|CAUSE| cervicalgie
    fatigue_visuelle["Fatigue visuelle"]
    S -->|CAUSE| fatigue_visuelle
    lombalgie_assise["Lombalgie assise"]
    S -->|CAUSE| lombalgie_assise
    secheresse_oculaire["Secheresse oculaire"]
    S -->|CAUSE| secheresse_oculaire
    syndrome_canal_carpien_ecran["Syndrome canal carpien ecran"]
    S -->|CAUSE| syndrome_canal_carpien_ecran
...
> Pour la vue complète : `kg/exports/debby_kg_travail_ecran_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/travail-ecran
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance travail_ecran`
