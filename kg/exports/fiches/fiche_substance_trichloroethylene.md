# Fiche pédagogique — **Trichloroéthylène**
...
- **Nom français** : Trichloroéthylène
- **Nom anglais** : Trichloroethylene
- **N° CAS** : `79-01-6`
...
|---|---|---|---|
| **Encephalopathie tce** | neurologique | moderee | IARC-1 |
| **Intoxication aigue tce** | neurologique | moderee | IARC-1 |
| **Cancer renal tce** | cancer | grave | IARC-1 |
...
**INDUSTRIE** : Degraissage metaux, Mecanicien, Menuisier, Pressing
...
|---|---|---|---|---|
| Cancer renal tce | **Créatininémie** | 12 mois | `HAS-2022` | 2022 |
| Encephalopathie tce | **Examen neurologique clinique** | 12 mois | `HAS-2021` | 2021 |
...
graph LR
    S["Trichloroéthylène"]
    encephalopathie_tce["Encephalopathie tce"]
    S -->|CAUSE| encephalopathie_tce
    intoxication_aigue_tce["Intoxication aigue tce"]
    S -->|CAUSE| intoxication_aigue_tce
    cancer_renal_tce["Cancer renal tce"]
    S -->|CAUSE| cancer_renal_tce
    RG_12["RG-12"]
    encephalopathie_tce -.->|classifiée dans| RG_12
...
> Pour la vue complète : `kg/exports/debby_kg_trichloroethylene_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/trichloroethylene
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance trichloroethylene`
