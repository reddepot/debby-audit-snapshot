# Fiche pédagogique — **Xylènes (mélange m, o, p)**
...
- **Nom français** : Xylènes (mélange m, o, p)
- **Nom anglais** : Xylenes
- **N° CAS** : `1330-20-7`
- **Catégorie** : solvant_aromatique
- **VLEP 8h** : `221.0 mg/m³`
- **VLEP court terme** : `442.0 mg/m³`

## 2. Pathologies professionnelles induites

| Pathologie | Type | Sévérité | Niveau de preuve |
|---|---|---|---|
| **Atteinte auditive solvants** | autre | moderee | IARC-3 |
| **Encephalopathie solvants** | neurologique | moderee | IARC-3 |
| **Dermatite xylene** | cutanee | legere | IARC-3 |
...
**INDUSTRIE** : Colle, Imprimeur, Peintre

**SANTE** : Laboratoire histo
...
|---|---|---|---|---|
| Atteinte auditive solvants | **Audiogramme** | 12 mois | `INRS-2021` | 2021 |
| Encephalopathie solvants | **Examen neurologique clinique** | 12 mois | `HAS-2021` | 2021 |
...
```mermaid
graph LR
    S["Xylènes (mélange m, o, p)"]
    atteinte_auditive_solvants["Atteinte auditive solvants"]
    S -->|CAUSE| atteinte_auditive_solvants
    encephalopathie_solvants["Encephalopathie solvants"]
    S -->|CAUSE| encephalopathie_solvants
    dermatite_xylene["Dermatite xylene"]
    S -->|CAUSE| dermatite_xylene
    RG_4_BIS["RG-4-BIS"]
    atteinte_auditive_solvants -.->|classifiée dans| RG_4_BIS
    RG_84["RG-84"]
    atteinte_auditive_solvants -.->|classifiée dans| RG_84
...
> Pour la vue complète : `kg/exports/debby_kg_xylene_v0.1.mermaid.md`

## 8. Sources et traçabilité

- **Source officielle substance** : https://www.inrs.fr/risques/xylene
...
- `pipeline` : `kg/scripts/export_fiche_pedagogique.py --substance xylene`
